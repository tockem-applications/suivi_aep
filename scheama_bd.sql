...
update facture f
    ...
    inner join (select i2.id_compteur as id_compteur, f2.montant_verse as montant_verse, mf2.id as id_mois_facturation
                from facture f2
                         inner join indexes i2 on f2.id_indexes = i2.id
                         inner join mois_facturation mf2 on i2.id_mois_facturation = mf2.id
                where mf2.id=53
                ) as sept
set f.montant_verse = sept.montant_verse
where mf.id = 52 and i.id_compteur = sept.id_compteur
