...
//        $liste = ob_get_clean();
        ...
        // La creation d'un AEP se fait desormais dans la modale #createAepModal
        // (presentation/aep_components.php), identique a celle de modification.
        // Cette page pleine n'existe plus ; on renvoie vers la liste des AEP
        // plutot que d'afficher une page vide a qui suivrait un vieux lien.
        header('Location: index.php?page=aep');
        exit;
