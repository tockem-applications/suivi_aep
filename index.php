...
<head>
    ...
    <style>
        ...
        ::-webkit-scrollbar-thumb:hover {
            background: grey;
            /* Couleur lorsque la souris survole */
        }

        .fixed-div {
            /*width: 100%; !* Prend toute la largeur sur mobile *!*/
            height: 92vh;
            /* Hauteur automatique pour le contenu */
        }
        ...
        .export-button {
            ...
            /* Vert pour une apparence moderne */
            color: white;
            padding: 12px 20px;
            border: none;
            border-radius: 50%;
        ...
        .export-button:active {
            ...
            /* Retour à la position initiale au clic */
        }
